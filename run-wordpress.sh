...
#sudo -u www-data -s wp core install --title=$WP_TITLE --admin_user=$WP_ADMIN_USER --admin_password=$WP_ADMIN_PASSWORD --admin_email=$WP_ADMIN_EMAIL && sudo -u www-data -s wp plugin activate --all
